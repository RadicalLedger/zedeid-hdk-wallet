...
describe('HD Wallet Ethr Method', function () {
    it('create master node', async () => {
        ...
        const wallet = new Wallet(new EthrMethod());

        wallet.fromSeed(seed);
        const keys = await wallet.getMasterKeys();

        expect(keys).toEqual({
            did: 'did:ethr:0x056db290f8ba3250ca64a45d16284d04bc6f5fbf',
            ...
            didDocument: {
                ...
                id: 'did:ethr:0x056db290f8ba3250ca64a45d16284d04bc6f5fbf',
                publicKey: [
                    {
                        id: 'did:ethr:0x056db290f8ba3250ca64a45d16284d04bc6f5fbf#owner',
                        owner: 'did:ethr:0x056db290f8ba3250ca64a45d16284d04bc6f5fbf',
                ...
                authentication: [
                    {
                        ...
                        publicKey: 'did:ethr:0x056db290f8ba3250ca64a45d16284d04bc6f5fbf#owner'
                    }
                ],
                assertionMethod: [
                    {
    ...
    it('create child node 1', async () => {
        ...
        expect(keys).toEqual({
            did: 'did:ethr:0xbf6e48966d0dcf553b53e7b56cb2e0e72dca9e19',
            ...
            didDocument: {
                '@context': 'https://w3id.org/did/v1',
                id: 'did:ethr:0xbf6e48966d0dcf553b53e7b56cb2e0e72dca9e19',
                publicKey: [
                    {
                        id: 'did:ethr:0xbf6e48966d0dcf553b53e7b56cb2e0e72dca9e19#owner',
                        owner: 'did:ethr:0xbf6e48966d0dcf553b53e7b56cb2e0e72dca9e19',
                        type: 'Secp256k1VerificationKey2018',
                ...
                authentication: [
                    {
                        type: 'Secp256k1SignatureAuthentication2018',
                        publicKey: 'did:ethr:0xbf6e48966d0dcf553b53e7b56cb2e0e72dca9e19#owner'
                    }
                ],
                assertionMethod: [
                    {
    ...
    it('create child node 2', async () => {
        ...
        expect(keys).toEqual({
            did: 'did:ethr:0x29379f45f515c494483298225d1b347f73d1babf',
            ...
            didDocument: {
                '@context': 'https://w3id.org/did/v1',
                id: 'did:ethr:0x29379f45f515c494483298225d1b347f73d1babf',
                publicKey: [
                    {
                        id: 'did:ethr:0x29379f45f515c494483298225d1b347f73d1babf#owner',
                        owner: 'did:ethr:0x29379f45f515c494483298225d1b347f73d1babf',
                        type: 'Secp256k1VerificationKey2018',
                ...
                authentication: [
                    {
                        type: 'Secp256k1SignatureAuthentication2018',
                        publicKey: 'did:ethr:0x29379f45f515c494483298225d1b347f73d1babf#owner'
                    }
                ],
                assertionMethod: [
                    {
    ...
    it('create child node 3', async () => {
        ...
        expect(keys).toEqual({
            did: 'did:ethr:0xd8e85fbbb4b3b3c71c4e63a5580d0c12fb4d2f71',
            ...
            didDocument: {
                '@context': 'https://w3id.org/did/v1',
                id: 'did:ethr:0xd8e85fbbb4b3b3c71c4e63a5580d0c12fb4d2f71',
                publicKey: [
                    {
                        id: 'did:ethr:0xd8e85fbbb4b3b3c71c4e63a5580d0c12fb4d2f71#owner',
                        owner: 'did:ethr:0xd8e85fbbb4b3b3c71c4e63a5580d0c12fb4d2f71',
                        type: 'Secp256k1VerificationKey2018',
                ...
                authentication: [
                    {
                        type: 'Secp256k1SignatureAuthentication2018',
                        publicKey: 'did:ethr:0xd8e85fbbb4b3b3c71c4e63a5580d0c12fb4d2f71#owner'
                    }
                ],
                assertionMethod: [
                    {
    ...
    it('create child node 4', async () => {
        ...
        expect(keys).toEqual({
            did: 'did:ethr:0x1d3462d2319ac0bfc1a52e177a9d372492752130',
            ...
            didDocument: {
                '@context': 'https://w3id.org/did/v1',
                id: 'did:ethr:0x1d3462d2319ac0bfc1a52e177a9d372492752130',
                publicKey: [
                    {
                        id: 'did:ethr:0x1d3462d2319ac0bfc1a52e177a9d372492752130#owner',
                        owner: 'did:ethr:0x1d3462d2319ac0bfc1a52e177a9d372492752130',
                        type: 'Secp256k1VerificationKey2018',
                ...
                authentication: [
                    {
                        type: 'Secp256k1SignatureAuthentication2018',
                        publicKey: 'did:ethr:0x1d3462d2319ac0bfc1a52e177a9d372492752130#owner'
                    }
                ],
                assertionMethod: [
                    {
    ...
    it('create child node 5', async () => {
        ...
        expect(keys).toEqual({
            did: 'did:ethr:0x73659c60270d326c06ac204f1a9c63f889a3d14b',
            ...
            didDocument: {
                '@context': 'https://w3id.org/did/v1',
                id: 'did:ethr:0x73659c60270d326c06ac204f1a9c63f889a3d14b',
                publicKey: [
                    {
                        id: 'did:ethr:0x73659c60270d326c06ac204f1a9c63f889a3d14b#owner',
                        owner: 'did:ethr:0x73659c60270d326c06ac204f1a9c63f889a3d14b',
                        type: 'Secp256k1VerificationKey2018',
                ...
                authentication: [
                    {
                        type: 'Secp256k1SignatureAuthentication2018',
                        publicKey: 'did:ethr:0x73659c60270d326c06ac204f1a9c63f889a3d14b#owner'
                    }
                ],
                assertionMethod: [
                    {
